...
namespace Inventarios
{
    class Simulacion
    {
        ...
        public void Iniciar()
        {
            int totalSer, numVenta = 1;

//            for (int d = 0; d<20; d++)
  //          {
                //totalSer = aleatorio.Next(0,10);
                totalSer = 1;
    ...
    //        }
        ...
        private void obtenerProducto(ref int id, ref float precio)
        {
            ...
            idP = aleatorio.Next(listProd.Count);
            prod = listProd[idP];
            id = (int)prod[0];
            precio = Convert.ToSingle(prod[1]);
